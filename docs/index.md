...
- [User Guide](USER_GUIDE.md) — install, first import, dry-run
- [Settings Reference](SETTINGS_REFERENCE.md) — every setting explained
- [FAQ](FAQ.md) — common questions
- [Troubleshooting](TROUBLESHOOTING.md) — fix import and sync issues
